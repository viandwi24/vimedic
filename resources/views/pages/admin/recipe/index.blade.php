            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <label>Patient</label>
                        <select name="patient_id" class="select2 form-control" id="selectPatient"></select>
                    </div>
                    <div class="form-group">
                        <label>Note</label>
        ...
        const vm = new Vue({
            ...
            methods: {
                ...
                editModal(recipe) {
                    this.action = 'edit';
                    this.recipe = recipe;
                    this.recipe.patient = this.recipe.patient_id;
                    this.loadSelect2();
                    this.carts = this.recipe.medicines;
                    $('#selectPatient').val(this.recipe.patient).trigger('change').trigger('click');
                    $('.modal#modal').modal('show');
                },
                create() {
